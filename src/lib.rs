// src/lib.rs
/*
 * Core library for CryptoWatchdog
 */
...
#[derive(Debug)]
pub struct CryptoWatchdogProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CryptoWatchdogProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CryptoWatchdog processing");
    
    let mut processor = CryptoWatchdogProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CryptoWatchdogProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CryptoWatchdogProcessor::new(false);
